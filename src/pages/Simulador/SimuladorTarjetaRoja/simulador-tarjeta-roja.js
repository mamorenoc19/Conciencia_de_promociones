...
import styles from './simulador-tarjeta-roja.module.css'
import { Link} from "react-router-dom";
import { useHistory} from "react-router-dom";
import {useState} from 'react'

function SimuladorTarjetaRoja(){
    ...
    const handleSubmit = (e) => {
        ...
        localStorage.setItem("datosRoja",JSON.stringify(blog));
        history.push('/resultado-tarjeta-roja');
    }
    ...
    return (
        ...
        <form className={styles.simulatorForm} onSubmit={handleSubmit}>
            ...
            <div className={styles.simulatorField}>
                ...
                <a href="#resultado-tarjeta-roja"><input className={styles.submitButton} type="submit" value="Realizar simulación"/></a>
...
export default SimuladorTarjetaRoja;